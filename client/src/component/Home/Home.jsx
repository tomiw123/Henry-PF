    ...
    <div>
      ...
      <div>
        <div className={style.container}>
          <h1 className={style.slogan}>PRIMERO LO PROBAMOS, DESPUES TE LO OFRECEMOS</h1>
          <p className={style.description}>Los productos que usamos todos los dias pueden ser tuyos a los mejores precios!</p>
